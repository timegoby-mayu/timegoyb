...
/**
 * 描述:[com_paasit_pai_core_demo][人员]更新方法的ResponseDTO
 * @version: 0_1
 * @author: AutoGenerate
 * @date: 2017-10-11 16:07:48
 */
@Data
@ApiModel(description = "[com_paasit_pai_core_demo][人员]更新方法的ResponseDTO")
public class DemoF03RespM01 extends ServiceResponseBase implements Serializable {
