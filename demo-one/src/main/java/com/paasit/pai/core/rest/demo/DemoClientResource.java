...
import com.paasit.pai.core.feign.DemoClient;
 ...
 * @version: 0_1
 * @author: 谷春
 * @date: 2017-12-19 20:24:56
 */
@RestController("DemoClientResource")
@RequestMapping("/api/client")
@Api(value="[人员]资源操作接口")
public class DemoClientResource {
    
    private final Logger log = LoggerFactory.getLogger(DemoClientResource.class);

    /**
     * 插入人员机能
     */
    @Autowired
    private final DemoClient demoClient = null;
    ...
    public ResponseEntity<DemoF01RespM01> createDemo(@ApiParam @RequestBody @Validated DemoF01ReqtM01 demoF01ReqtM01)
        ...
        DemoF01RespM01 result = demoClient.createDemo(demoF01ReqtM01);
    ...
    public ResponseEntity<DemoF02RespM01> deleteDemo(@ApiParam @RequestBody @Validated DemoF02ReqtM01 demoF02ReqtM01)
        ...
        DemoF02RespM01 result = demoClient.deleteDemo(demoF02ReqtM01);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
    ...
    public ResponseEntity<DemoF03RespM01> updateDemo(@ApiParam @RequestBody @Validated DemoF03ReqtM01 demoF03ReqtM01)
        ...
        DemoF03RespM01 result = demoClient.updateDemo(demoF03ReqtM01);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
    ...
    public ResponseEntity<DemoF04RespM01> getDemoByPage(@ApiParam @RequestBody @Validated DemoF04ReqtM01 demoF04ReqtM01) throws Exception {
        ...
        DemoF04RespM01 result = demoClient.getDemoByPage(demoF04ReqtM01);
        return new ResponseEntity<>(result, HttpStatus.OK);
    }
    ...
    public ResponseEntity<DemoF04RespS01> getDemoById(@ApiParam(value="主键id", required = true) @PathVariable String id) throws Exception {
        ...
        DemoF04RespS01 demoF04RespM01 = demoClient.getDemoById(id);
        return new ResponseEntity<>(demoF04RespM01, HttpStatus.OK);
    }
}
